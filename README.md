# Hassan Ali | Data & Business Analytics Portfolio

**Transforming complex datasets into strategic business, ERP, and supply chain solutions.**
...
- **Professional Certifications:** Hold multiple advanced and specialized certificates in Data Analytics, Business Analysis, and Logistics Management.
- **Capstone Project:** Currently developing a comprehensive business and data analysis project focused on **Nokia's** market strategies and business model.
...
## 📁 Projects Directory
*(Click on any project directory below to view the datasets, methodologies, and technical insights)*

| Project | Domain | Tech Stack | Overview |
| :--- | :--- | :--- | :--- |
| **[ERP Sales Data Analytics](./ERP-Sales-Data-Analytics-Project)** | ERP / Business | Data Analysis | Deep dive into ERP records to extract actionable sales and operational insights. |
| **[Odoo Sales Intelligence](./Odoo_Sales_Intelligence_Dashboard)** | ERP / Sales | Odoo | Configured intelligence dashboard for real-time sales performance tracking. |
| **[Supply Chain Analysis](./Supply_Chain_Analysis_sql)** | Supply Chain | SQL | Advanced database querying to track and optimize supply chain metrics. |
| **[Supply Chain Analytics](./Supply-Chain-Analytics-Tableau)** | Supply Chain | Tableau | Visual dashboards identifying logistics efficiency and operational bottlenecks. |
| **[Supply Chain Dashboard](./Supply-Chain-Dashboard-Excel)** | Supply Chain | Excel | Comprehensive operational tracking for supply chain KPIs. |
...
---
## 📫 Let's Connect
- **LinkedIn:** [Hassan Ali](https://www.linkedin.com/in/hassan-ali-ha2026)
